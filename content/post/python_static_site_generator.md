...
description = "The source code for my Python static site generator"
date = 2015-04-26

aliases = ["/python_static_site_generator", "/post/python_static_site_generator"]

[taxonomies]
tag = ["code", "random", "projects"]
+++
